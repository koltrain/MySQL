...
CREATE TABLE `страны` (
  `id` int(11) NOT NULL,
  `Россия` varchar(45) DEFAULT NULL,
  `Канада` varchar(45) DEFAULT NULL,
  `Китай` varchar(45) DEFAULT NULL,
  `Индия` varchar(45) DEFAULT NULL,
  `США` varchar(45) DEFAULT NULL,
  `Бразилия` varchar(45) DEFAULT NULL,
  `Автралия` varchar(45) DEFAULT NULL,
  `Аргентина` varchar(45) DEFAULT NULL,
  `Казахстан` varchar(45) DEFAULT NULL,
  `Судан` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
